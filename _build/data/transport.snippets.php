...
$snippets[1] ->fromArray(array(
    ...
    'snippet' => file_get_contents($sources['source_core'].'/elements/snippets/sbsgetinterests.snippet.php'),
    'properties' => '',
),'',true,true);
...
$snippets[2] ->fromArray(array(
    ...
    'snippet' => file_get_contents($sources['source_core'].'/elements/snippets/sbssubscribe.snippet.php'),
    'properties' => '',
),'',true,true);
...
$snippets[3] ->fromArray(array(
    ...
    'snippet' => file_get_contents($sources['source_core'].'/elements/snippets/sbsloadregisterjs.snippet.php'),
    'properties' => '',
),'',true,true);
...
$snippets[4] ->fromArray(array(
    ...
    'snippet' => file_get_contents($sources['source_core'].'/elements/snippets/sbsgetcurrentprefs.snippet.php'),
    'properties' => '',
),'',true,true);
return $snippets;