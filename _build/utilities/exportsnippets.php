...
echo '<h3><br />Processing Snippets</h3>';
...
foreach ($snippets as $snippet) {
    ...
    echo '<br />Processing: ' . $snippet->get('name');
    ...
    if (!$debug) {
        ...
        fwrite($transportFp, "    'snippet' => file_get_contents(\$sources['source_core']." . "'/elements/snippets/" . $prefix . strtolower($snippet->get('name')) . ".snippet.php'),\n");
...
return '<br />Finished processing snippets';
