<?php
/**
 * Utility snippet for SubscribeMe development
 *
...
$sources= array (
    'root' => $root,
    'build' => $root . '_build/',
    'source_core' => $root . 'core/components/subscribeme',
    'source_assets' => $root . 'assets/components/subscribeme',
    'data' => $root . '_build/data/',
    'docs' => $root . 'core/components/subscribeme/docs/',
);
unset($root);
...
if (! $category) {
    ...
    $category->set('category','SubscribeMe');
}
