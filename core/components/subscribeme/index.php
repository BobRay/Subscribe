<?php
/**
 * Action file for the components menu item of the SubscribeMe package
 * @author Bob Ray
 * 2/4/11
 *
 * @package subscribeme
 ...
 * When you select SubscribeMe on the Components menu.
...
$modx->regClientCSS($path . 'components/subscribeme/css/subscribeme.css');
$output = '<div class="subscribeme">';
