...
$_lang['subscribe'] = 'Abonnieren';
$_lang['subscribe.menu_desc'] = 'Abonnieren Beschreibung';

/* Interest Report strings */
$_lang['sbs_total_users_header'] = 'Gesamtzahl der aktiven Benutzer';
$_lang['sbs_interests_section_header'] = 'Interessen';
$_lang['sbs_topic_header'] = 'Thema';
$_lang['sbs_user_count_header'] = 'Benutzer';
$_lang['sbs_groups_section_header'] = 'Benutzer Gruppen';
$_lang['sbs_group_header'] = 'Gruppen';
$_lang['sbs_no_interest_tpl_error'] = 'Es wurde kein Interessenlistenabschnitt gefunden';
...
$_lang['sbs_subscribe_message'] = 'Abonnent werden!';
$_lang['sbs_subscribe_button_text'] = 'Abonniert mich';
$_lang['sbs_login_button_text'] = 'Login';
$_lang['sbs_why_button_text'] = 'Warum sollte ich?';
$_lang['sbs_privacy_button_text'] = 'Datenschutz-Bestimmungen';
$_lang['sbs_close_button_text'] = 'Schließen';
$_lang['sbs_logout_button_text'] = 'Logout';
$_lang['sbs_manage_prefs_button_text'] = 'Einstellungen verwalten';
