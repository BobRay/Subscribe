<?php
/**
 * Action file for the components menu item of the Subscribe package
 * @author Bob Ray
 * 2/4/11
 *
 * @package subscribe
 ...
 * When you select Subscribe on the Components menu.
...
$modx->regClientCSS($path . 'components/subscribe/css/subscribe.css');
